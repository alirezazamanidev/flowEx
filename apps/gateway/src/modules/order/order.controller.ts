import { ORDER_PACKAGE_NAME, ORDER_SERVICE_NAME, OrderServiceClient } from '@app/common/interfaces/order';
...
export class OrderController implements OnModuleInit {
  ...
  constructor(@Inject(GrpcPackageNames.ORDER) private readonly client:ClientGrpc) {}
  ...
  @ApiOperation({ summary: 'create order' })
    ...
    create(@Body() dto:CreateOrderDto,@Req()req:Request) {
      return this.orderServiceClient.createOrder({userId:req.user.id ,...dto});
    }
}
